  ...
  return (
    <section className="h-screen hero-sec bg-cover bg-center relative">
      <div className="absolute inset-0 bg-(--nav-bg)/75 flex flex-col justify-center items-center text-white text-center p-4">
        ...
        <button
          to="/contact"
          className="cursor-pointer text-lg  hover:bg-(--main-color) hover:text-(--nav-bg) bg-(--nav-bg) text-(--main-color)  transition duration-300 font-semibold py-2 px-6 rounded-md"
